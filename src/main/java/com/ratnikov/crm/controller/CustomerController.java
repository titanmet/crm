...
import com.ratnikov.crm.service.CustomerService;
...
import static com.ratnikov.crm.controller.ApiMapping.CUSTOMERS_REST_URL;
...
public class CustomerController {
    ...
    @PutMapping
    public ResponseEntity<CustomerDTO> editCustomer(@RequestBody Customer customers){
    ...
    public Customer postNewCustomer(@RequestBody CustomerDTO customer) {
